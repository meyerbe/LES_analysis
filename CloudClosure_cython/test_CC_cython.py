...
from CC_thermodynamics import aux
# from CC_thermodynamics import aux_c

def main():
    print('test CC cython')
    aux()
    CC_thermodynamics.aux()
    # CC_thermodynamics.aux_c()
    # aux_c()

    # from CC_thermodynamics import ClausiusClapeyron
    # from CC_thermodynamics import ClausiusClapeyron_c
    CC = CC_thermodynamics.ClausiusClapeyron()
    CC_c = CC_thermodynamics.ClausiusClapeyron_c()
