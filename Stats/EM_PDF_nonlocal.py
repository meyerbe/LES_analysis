...
def main():
    ...
    for d in files_:
        ...
        for var in var_list:
            ...
            ncomp = 2
            clf = Gaussian_mixture(data, ncomp, var, np.int(d[0:-3]))
            ...
            plot_covar_matrix(covar_tot, corr_tot, zrange, zrange, var, ncomp, t)
...
#----------------------------------------------------------------------
#----------------------------------------------------------------------
def Gaussian_mixture(data, ncomp, var_name, t):
...
#----------------------------------------------------------------------
def plot_covar_matrix(covar, corr, x_, y_, var_name, ncomp, t):
