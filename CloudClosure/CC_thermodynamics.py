...
#----------------------------------------------------------------------
def sat_adj_fromentropy_double(p, s, qt):

    print ('')
    print('saturation adjustment from entropy double')
    # makes no difference!
    '''
    ...
    # print('types first guess: ')
    # print(type(pv_1), type(pd_1), type(pv_star_1), type(qv_star_1), type(T_1))     # T_1 is float32
    # print('')
    ...
    if (qt <= qv_star_1):
        ...
        # print('second guess:')
        # print(type(L_1), type(ql_1), type(s_1), type(f_1), type(T_2), type(delta_T))        # ok
        ...
        ql_2 = qt - qv_star_2
        # print(type(pv_star_2), type(qv_star_2), type(ql_2))     # ok
        while(delta_T >= 1.0e-3 or ql_2 < 0.0):
            ...
            pd_2 = p - pv_2
            ql_2 = qt - qv_star_2
            # print(type(pv_star_2), type(qv_star_2), type(pv_2), type(pd_2), type(ql_2))     # ok
            if ql_2 < 0.0:
            ...
            # print('T_n: ')
            # print(type(L_2), type(s_2), type(f_2), type(T_n))   # ok
            ...
            f_1 = f_2
            delta_T = np.abs(T_2 - T_1)
            # print(type(T_1), type(T_2), type(T_n), type(delta_T))
            count += 1
        T = T_2
        qv = qv_star_2
        ql = np.double(ql_2)
